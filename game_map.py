...
class GameMap:
    def __init__(
        self, engine: Engine, width, height, entities: Iterable[Entity] = ()
    ):
        self.engine = engine
    ...
    def get_actor_at_location(self, x, y) -> Optional[Actor]:
